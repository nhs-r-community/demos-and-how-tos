...
WhichYearGroup	<- 8							# year group 7/8/9/10/11 as per TestScoresDBSep2018.xlsx file
...
df <- df %>% filter (class==WhichClass & subject==WhichSubject & test_desc==WhichTestDesc)
	
# init
setwd(paste(grass_directory, "GRASS Plots", WhichSubject, sep="/"))
my_file_name <- unique(paste("Yr", 	df$class[df$test_desc==WhichTestDesc], 
